...
if DataModule2.Zsatuan.Locate('nama',Edit1.Text,[]) and
...
begin
SQL.Clear;
SQL.Add('insert into satuan (nama , deskripsi) values("'+Edit1.Text+'" , "'+Edit2.Text+'")');ExecSQL ;
SQL.Clear;
...
begin
  ...
  begin
    ...
    begin
    SQL.Clear;
      SQL.Add('update satuan set nama = "' + Edit1.Text + '", deskripsi = "' + Edit2.Text + '" where id = "' + a + '"');      ExecSQL;
      SQL.Clear;
